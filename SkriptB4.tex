...
\begin{document}
	...
	\begin{beispiele}\label{1.1.3}\hfill
			\begin{enumerate}[(a)]
	...
	\begin{bemerkung}\label{1.1.5}\hfill\newline
		...
		Insbesondere sind zum Beispiel das von einem $a \in R$ erzeugte Ideal und der davon erzeugte Untermodul als Menge dasselbe $(a)_R = Ra \overset{R\ komm.}{=} \set{ab \mid b \in R} = aR$.
	...
	\begin{beispiele}\label{1.1.7}\hfill
		\begin{enumerate}[(a)]
