...
\begin{document}
	...
	\begin{definition}\label{1.2.1}
		...
		von $\displaystyle\prod_{i\in I} M_i$ \emph{die (\"au\ss ere) direkte Summe}\index{Modul@\textbf{Modul}!\"Au\ss ere Direkte Summe} der $M_i$ ($i \in I$). Man fasst $M_j$ ($j \in I$ h\"aufig) als Untermodul von $\displaystyle\bigoplus_{i \in I} M_i$ auf verm\"oge der Einbettung 
